...
builder.Services.AddTransient<ILocationService,  LocationServices>();
builder.Services.AddTransient<ILocationRepository, LocationsRepository>();
builder.Services.AddTransient<IDepartmentService, DepartmentServices>();
builder.Services.AddTransient<IDepartmentRepository, DepartmentsRepository>();
